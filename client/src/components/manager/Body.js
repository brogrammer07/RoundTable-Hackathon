...
const Body = () => {
  ...
  const manager = useSelector((state) => state.admin.allManager);
    ...
    <div className="flex-[0.8] mt-3">
      <div className="space-y-5">
        ...
        <div className="flex flex-col mr-5 space-y-4 overflow-y-hidden">
          <div className="bg-white h-[8rem] rounded-xl shadow-lg grid grid-cols-3 justify-between pl-32 items-center space-x-4">
            <div className="flex items-center space-x-4 border-r-2">
              ...
              <div className="flex flex-col">
                <h1>Managers</h1>
                <h2 className="text-2xl font-bold">{manager?.length}</h2>
              </div>
            </div>
            <div className="flex items-center space-x-4 border-r-2">
            ...
            <div className="flex items-center space-x-4 ">
              ...
              <div className="flex flex-col">
                <h1>Notices</h1>
                <h2 className="text-2xl font-bold">{notices?.length}</h2>
              </div>
            </div>
          </div>
