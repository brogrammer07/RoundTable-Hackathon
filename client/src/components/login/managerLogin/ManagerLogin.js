...
import { managerSignIn } from "../../../redux/actions/managerActions";
...
const ManagerLogin = () => {
  ...
  const login = (e) => {
    ...
    setLoading(true);
    dispatch(
      managerSignIn({ username: username, password: password }, navigate)
    );
  };
    ...
    <div className="bg-[#d65158] h-screen w-screen flex items-center justify-center">
      <div className="grid grid-cols-2">
        ...
        <form
          ...
          <h1 className="text-white text-3xl font-semibold">Manager</h1>
